...
namespace negocio
{
    public class PersonaNegocio
    {
        ...
        public List<Persona> listarChoferes()
        {
            ...
            string database = " FROM " + db_personas + " ORDER BY apellido ASC;";
        ...
        public void agregar(Persona nvCh) 
        {
            ...
            try
            {
               ...
               datos.setearConsulta("INSERT INTO cantarini_control.dbo.personas (dni, idPuesto, idEmpresa, interno, apellido, nombres, ingreso, Observaciones) VALUES (" + nvCh.Dni + ", " + idPuesto + ", " + idEmpresa + ", " + nvCh.Interno + ", '" + nvCh.Apellido.ToUpper() + "', '" + nvCh.Nombres.ToUpper() + "', convert(datetime, getdate()), '" + nvCh.Observaciones.ToUpper() + "');");
        ...
        public void modificar(Persona mdCh) 
        {
            ...
            */
            ...
            try
            {
                datos.setearConsulta("UPDATE cantarini_control.dbo.personas SET idPuesto=" + idPuesto + ", idEmpresa= " + idEmpresa + ", interno= " + mdCh.Interno + ", apellido='" + mdCh.Apellido.ToUpper() + "', nombres='" + mdCh.Nombres.ToUpper() + "', Observaciones='" + mdCh.Observaciones.ToUpper() + "', activo=" + activo + ", okAdm=" + okAdm + ", okTrafico=" + okTrafico + " WHERE dni=" + mdCh.Dni + ";");
                datos.ejecutarAccion();
            }
            catch (Exception ex)
            {
